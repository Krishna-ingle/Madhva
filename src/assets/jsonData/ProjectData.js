    ...
    sections: [
      {
        ...
        items: [
          'Vendor registration and multi-shop management',
          'Product and service listing with pricing and offers',
          'Order and employee management',
          'Advertisement and banner promotion',
          'Customer browsing by location and category'
        ]
      },
      {
        heading: 'Backend & Engineering',
        items: [
          'Built with Spring Boot & RESTful APIs',
          'Database integration (MongoDB / SQL)',
          'Structured Entity–Repository–Service architecture',
